...
3. If the program output an error like "RuntimeError: Params.pkl is a zip archive (did you mean to use torch.jit.load()?)", please re-install the pytorch according to your cuda version
